...
if (document.getElementById('recipe-grid')) {
    function renderRecipes(recipes) {
        ...
        recipes.forEach(recipe => {
            ...
            card.className = 'bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden h-full flex flex-col';
            card.innerHTML = `
                <a href="/recipes/${recipe.id}" class="block group">
                    <div class="relative h-64 overflow-hidden shrink-0">
                        ${recipe.recipe_images && recipe.recipe_images.length > 0 ?
                            ...
                            : `<div class="w-full h-full bg-gradient-to-br from-orange-200 via-pink-200 to-purple-300 dark:from-gray-600 dark:to-gray-700 flex items-center justify-center"><svg class="w-20 h-20 text-white opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg></div>`}
