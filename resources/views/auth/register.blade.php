        ...
        <div class="bg-white  rounded-xl shadow-lg overflow-hidden border border-gray-200 ">
            <div class="p-6 sm:p-8 bg-gradient-to-b from-white to-emerald-50  ">
                <form method="POST" action="{{ route('register') }}" class="space-y-6" enctype="multipart/form-data">
                    ...
                    <!-- Name -->
                    <div>
                        <label for="name" class="block text-sm font-semibold text-emerald-700  mb-2 flex items-center">
                        ...
                        <input type="text" 
                               ...
                               required
                               autofocus
                               class="w-full px-4 py-3 rounded-lg border border-emerald-200  bg-white  text-gray-900  placeholder-gray-500  focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200"
                    ...
                    <!-- Email Address -->
                    <div>
                        <label for="email" class="block text-sm font-semibold text-green-700  mb-2 flex items-center">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <input type="email" 
                               ...
                               value="{{ old('email') }}"
                               required
                               class="w-full px-4 py-3 rounded-lg border border-green-200  bg-white  text-gray-900  placeholder-gray-500  focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200"
                    ...
                    <!-- Password -->
                    <div>
                        <label for="password" class="block text-sm font-semibold text-teal-700  mb-2 flex items-center">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <input type="password" 
                               ...
                               name="password" 
                               required
                               class="w-full px-4 py-3 rounded-lg border border-teal-200  bg-white  text-gray-900  placeholder-gray-500  focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200"
                    ...
                    <!-- Confirm Password -->
                    <div>
                        <label for="password_confirmation" class="block text-sm font-semibold text-cyan-700  mb-2 flex items-center">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <input type="password" 
                               ...
                               required
                               class="w-full px-4 py-3 rounded-lg border border-cyan-200  bg-white  text-gray-900  placeholder-gray-500  focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all duration-200"
