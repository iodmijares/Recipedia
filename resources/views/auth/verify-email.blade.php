...
<div class="py-6 sm:py-12">
    <!-- Hero Section -->
    <div class="bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-100   ">
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6">
        ...
        <div class="bg-white  rounded-xl shadow-lg overflow-hidden border border-gray-200 ">
            <div class="p-6 sm:p-8 bg-gradient-to-b from-white to-amber-50  ">
                ...
                <div class="text-center mb-8">
                    ...
                    <div class="bg-amber-50  border border-amber-200  rounded-lg p-4 mb-6">
                        <div class="flex items-start">
                            ...
                            <div class="text-left">
                                <p class="text-sm font-medium text-amber-800 ">Email sent to:</p>
                                <p class="text-sm text-amber-700 ">{{ auth()->user()->email }}</p>
                            </div>
                        </div>
                    </div>
                </div>
